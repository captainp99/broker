...
namespace BrokerBusinessTests
{
    public class BrokerTests
    {
        ...
        {
            // Act + Arrange
            var res = _brocker.BuyEquities(new BuyEquitiesRequest { TraderId = 1, EquityId = 1, NumberOfEquity = 1, RequestDateTime = new DateTime(2021, 12, 18, 9, 1, 1) });

            // Assert
            Assert.False(res.success);
            Assert.Equal("Not a valid day or time", res.message);
        }
        ...
        {
            // Act + Arrange
            var res = _brocker.SellEquities(new SellEquitiesRequest { TraderId = 1, EquityId = 1, NumberOfEquity = 1, RequestDateTime = new DateTime(2021, 12, 18, 9, 1, 1) });
